common = {
    ...
    "fields": {
        ...
        "oa_url": "oa_url",
        "pdf_url": "pdf url",
        "cited_by": "cited by count",
        "citation_percentile": "citation normalized percentile (value)",
        "issn": "ISSN",
...
texts = {
    "en": {
        ...
        "start_message": "📂 Scanning input folder and initializing OpenPrisma...",
    ...
    "es": {
        ...
        "start_message": "📂 Escaneando la carpeta de entrada e iniciando OpenPrisma...",
